...
var initGui = function initGui() {
  ...
  gui.addColor(palette, 'backgroundColor');
};
initGui();
...
function setCanvasSize() {
  ...
  canvas.style.cssText = 'opacity: 0.9;position:fixed;top:0;left:0;z-index: -2;width:100%;height:100%;pointer-events:none;';
}
setCanvasSize();
window.addEventListener('resize', setCanvasSize);
var Particle = function () {
  function Particle(x, y) {_classCallCheck(this, Particle);var
    maxLife = parameters.maxLife,radius = parameters.radius,speed = parameters.speed,colors = parameters.colors,deceleration = parameters.deceleration;backgroundColor=palette.backgroundColor;
