...
var settings = {
  ...
  url_dl: 'https://io.two3.cn/api/public/dl/1rAFuTMh', // path to a large file or garbage.php, used for download test. must be relative to this js file
  url_ul: '/api/connectivitycheck', // path to an empty file, used for upload test. must be relative to this js file
  url_ping: '/api/connectivitycheck', // path to an empty file, used for ping test. must be relative to this js file
  url_getIp: 'https://5650.top/api.php?action=getip', // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
